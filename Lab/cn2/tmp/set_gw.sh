...
host master {
   hardware ethernet 56:04:19:00:6e:c3;
...
host node2 {
   hardware ethernet 56:04:19:00:b9:80;
...
host registry {
   hardware ethernet 56:04:19:00:9d:a8;
...
echo '#!/bin/bash
websockify -D --web=/usr/share/novnc/ 6081 q-pod-74j.englab.juniper.net:5981
websockify -D --web=/usr/share/novnc/ 6082 q-pod-73g.englab.juniper.net:5949
websockify -D --web=/usr/share/novnc/ 6083 q-pod-73v.englab.juniper.net:5942
websockify -D --web=/usr/share/novnc/ 6084 q-pod-73o.englab.juniper.net:5993
websockify -D --web=/usr/share/novnc/ 6085 q-pod-74j.englab.juniper.net:5980
websockify -D --web=/usr/share/novnc/ 6086 q-pod-73o.englab.juniper.net:5994
' | sudo tee  /usr/local/bin/startup.sh
sudo chmod +x /usr/local/bin/startup.sh
echo "#!/bin/bash
echo "-------------------------"
echo "URL access to VNC: "
echo "console master : http://172.16.11.1:6081/vnc.html"
