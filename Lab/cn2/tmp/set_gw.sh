...
host master {
   hardware ethernet 56:04:19:00:a9:67;
   fixed-address 172.16.11.10;
}
host node1 {
   hardware ethernet 56:04:19:00:70:0c;
   fixed-address 172.16.11.11;
}
host node2 {
   hardware ethernet 56:04:19:00:6d:fe;
...
host registry {
   hardware ethernet 56:04:19:00:ac:05;
...
echo '#!/bin/bash
websockify -D --web=/usr/share/novnc/ 6081 q-pod-73o.englab.juniper.net:5917
