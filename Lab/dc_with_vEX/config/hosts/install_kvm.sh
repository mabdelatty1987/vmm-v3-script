...
virt-install --name ${VM} \
  ...
  --xml './devices/interface/vlan/tag/@id=1001' \
...
address 2001:dead:beef:aa01::1000:1/64
gateway 2001:dead:beef:aa01::1
EOF
...
gateway 172.16.2.1
iface eth0 inet6 static
address 2001:dead:beef:aa02::1000:2/64
gateway 2001:dead:beef:aa02::1
EOF
...
gateway 192.168.1.254
iface eth0 inet6 static
address 2001:dead:beef:aa01::1000:3/64
gateway 2001:dead:beef:aa01::1
EOF
