...
interface eth4 inet manual
  mtu 9000
auto wan1
interface wan1 inet manual
  post-up echo 0x4000 > /sys/class/net/wan1/bridge/group_fwd_mask
  bridge-ports eth1 eth2 
  bridge-stp 0
auto wan2
interface wan2 inet manual
  post-up echo 0x4000 > /sys/class/net/wan2/bridge/group_fwd_mask
