...
host master {
   hardware ethernet 56:04:19:00:5b:79;
   fixed-address 172.16.11.10;
}
host node1 {
   hardware ethernet 56:04:19:00:93:d8;
   fixed-address 172.16.11.11;
}
host node2 {
   hardware ethernet 56:04:19:00:65:54;
   fixed-address 172.16.11.12;
}
host node3 {
   hardware ethernet 56:04:19:00:7a:63;
   fixed-address 172.16.11.13;
}
host node4 {
   hardware ethernet 56:04:19:00:78:57;
   fixed-address 172.16.11.14;
}
host registry {
   hardware ethernet 56:04:19:00:81:9e;
   fixed-address 172.16.14.10;
}
host deployer {
   hardware ethernet 56:04:19:00:83:fa;
   fixed-address 172.16.11.15;
}
...
echo '#!/bin/bash
websockify -D --web=/usr/share/novnc/ 6081 q-pod-74k.englab.juniper.net:5903
websockify -D --web=/usr/share/novnc/ 6082 q-pod-73o.englab.juniper.net:5909
' | sudo tee  /usr/local/bin/startup.sh
sudo chmod +x /usr/local/bin/startup.sh
echo "#!/bin/bash
echo "-------------------------"
echo "URL access to VNC: "
echo "console registry : http://172.16.11.1:6081/vnc.html"
echo "console deployer : http://172.16.11.1:6082/vnc.html"
