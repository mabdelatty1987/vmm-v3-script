...
subnet 172.16.13.0 netmask 255.255.255.0 {
   range 172.16.13.100 172.16.13.150;
...
echo "console juju : http://172.16.11.1:6081/vnc.html"
echo "console cc : http://172.16.11.1:6082/vnc.html"
echo "console client1 : http://172.16.11.1:6083/vnc.html"
echo "console ext1 : http://172.16.11.1:6084/vnc.html"
echo "console node0 : http://172.16.11.1:6085/vnc.html"
