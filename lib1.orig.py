...
def get_hosts_config(d1):
	host_yes=['centos','ubuntu','debian','esxi','aos','aos_ztp','bridge','desktop']
...
def get_dhcp_config_orig(d1):
	dhcp_yes=['centos','ubuntu','debian','esxi','aos','aos_ztp','bridge','desktop','ssr']
	ssh=sshconnect(d1)
	cmd1="vmm args "
	stdin,stdout,sstderr=ssh.exec_command(cmd1)
	j = stdout.readlines()
...
def get_dhcp_config(d1):
	dhcp_yes=['centos','ubuntu','debian','esxi','aos','aos_ztp','bridge','desktop','paagent']
	ssh=sshconnect(d1)
	cmd1="vmm args "
	stdin,stdout,sstderr=ssh.exec_command(cmd1)
	j = stdout.readlines()
